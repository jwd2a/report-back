...
generated.name=source.name;generated.workers_dev=source.workers_dev;generated.d1_databases=source.d1_databases.map(d=>({...d,migrations_dir:"../../drizzle"}));generated.vars=source.vars;
